...
/**
 * This class is of optional use. Can be used to make a custom request with the Http class WITHOUT using the standard public methods. (Those are `Http.get`, `Http.post`, `Http.patch`, `Http.put`, `Http.delete`). 
