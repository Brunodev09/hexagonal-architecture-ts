...
const models: TsoaRoute.Models = {
    ...
    "ProjectSection": {
        "dataType": "refEnum",
        "enums": ["INVESTMENT","PAYMENTS","FUNDING","MANAGEMENT"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "userCreatedResponse": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/example/:agencyId/:projectType/agency',
            ...
            ...(fetchMiddlewares<RequestHandler>(exampleController.prototype.get)),

            async function exampleController_get(request: any, response: any, next: any) {
            const args = {
                    agencyId: {"in":"path","name":"agencyId","required":true,"dataType":"double"},
                    projectType: {"in":"query","name":"projectType","required":true,"ref":"ProjectSection"},
            };
            ...
            try {
                ...
                const controller: any = await container.get<exampleController>(exampleController);
        ...
        app.post('/user/create',
            ...
            ...(fetchMiddlewares<RequestHandler>(userController.prototype.post)),
